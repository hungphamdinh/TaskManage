...
const Images = {
  ...
  icTabTask: require('../../assets/ic-tab-task.png'),
  icTabPlus: require('../../assets/ic-tab-plus.png'),
  ...
  icShare: require('../../assets/ic-share.png'),
  icMessage: require('../../assets/ic-message.png'),
